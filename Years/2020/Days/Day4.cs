...
public static class Day4
{
    ...
    private class Passport
    {
        ...
        private static bool CheckNumbers(string value, int min, int max)
        {
        ...
        private static bool CheckHeight(string value)
        {
        ...
        private static bool CheckEyeColor(string value)
        {
        ...
        private static bool CheckHairColor(string value)
        {
            return Regex.Match(value, "^[#][0-9a-f]{6}$").Success;
        }

        private static bool CheckPassportID(string passportID)
        {
